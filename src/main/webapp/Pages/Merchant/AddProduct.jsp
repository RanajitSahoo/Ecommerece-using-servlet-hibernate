...
<!-- ======= Header ======= -->
	<header id="header" class="fixed-top ">
		<div
			...
			<h1 class="logo me-auto me-lg-0 " >
				<a href="index.html" style="color: black;" >CRAM<span style="color: #02fae1;" >P</span>S.</a>
			</h1>
	...
	<div class="wrapper ">
		...
		%>
		<div class="text-center mt-4 name">Add Product</div>
		<form class="p-3 mt-3" action="addProduct?id=<%=id %>" method="post">
			<div class="form-field d-flex align-items-center">
				<span class="far fa-user"></span> <input type="text" name="name"
					id="userName" placeholder="Name">
			</div>
			<div class="form-field d-flex align-items-center">
				<span class="fa fa-key"></span> <input type="text"
					name="image" id="email" placeholder="Put Image Url here">
			</div>
			<div class="form-field d-flex align-items-center">
				<span class="fa fa-user"></span> <input type="text" name="category"
					id="pwd" placeholder="E.g. Phone/Grocery/..">
			</div>
			<div class="form-field d-flex align-items-center">
				<span class="fas fa-key"></span> <input type="number"
					name="price" id="pwd" placeholder="Price of your Product">
			</div>
			<div class="form-field d-flex align-items-center">
				<span class="far fa-user"></span> <input type="number" name="stock"
					id="userName" placeholder="number of stock">
			</div>
			
			<button class="btn mt-3 bg-c" style="color:black;" >Save</button>
		</form>
		<div class="text-center fs-6">
            Already Registered? Please <a href="MerchantLogin.jsp">Login here</a>
        </div>
	</div></div>
