...
<body>
	...
	<header id="header" class="fixed-top ">
		<div
			...
			<h1 class="logo me-auto me-lg-0 " >
				<a href="index.html" style="color: black;" >CRA<span style="color: #02fae1;" >M</span>PS.</a>
			</h1>
	...
	<div class="wrapper ">
		...
		<div class="text-center mt-4 name">Merchant</div>
		<form class="p-3 mt-3" action="registerMerchant" method="post">
			<div class="form-field d-flex align-items-center">
				<span class="far fa-user"></span> <input type="text" name="name"
					id="userName" placeholder="Name">
			</div>
			<div class="form-field d-flex align-items-center">
				<span class="fas fa-key"></span> <input type="email"
					name="email" id="email" placeholder="Email">
			</div>
			<div class="form-field d-flex align-items-center">
				<span class="far fa-user"></span> <input type="password" name="password"
					id="pwd" placeholder="Password">
			</div>
			<div class="form-field d-flex align-items-center">
				<span class="fas fa-key"></span> <input type="password"
					name="cpassword" id="pwd" placeholder="ConfirmPassword">
			</div>
			<div class="form-field d-flex align-items-center">
				<span class="far fa-user"></span> <input type="text" name="mobileNumber"
					id="userName" placeholder="Phone Number">
			</div>
			
			<button class="btn mt-3 bg-c" style="color:black;" >Register</button>
		</form>
