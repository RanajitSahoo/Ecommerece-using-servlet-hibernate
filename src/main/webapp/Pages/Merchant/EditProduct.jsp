...
<!-- ======= Header ======= -->
	...
	<div class="wrapper ">
		...
		%>
		<div class="text-center mt-4 name">Edit Product</div>
		<form class="p-3 mt-3" action="updateProduct?pid=<%=p.getId() %>&mid=<%=mid %>"method="post" >
			<div class="form-field d-flex align-items-center">
				<span class="far fa-user"></span> <input type="text" name="name"
					id="userName" value="<%= p.getName()%>">
			</div>
			<div class="form-field d-flex align-items-center">
				<span class="fa fa-key"></span> <input type="text"
					name="image" id="email" value="<%= p.getImage()%>">
			</div>
			<div class="form-field d-flex align-items-center">
				<span class="fa fa-user"></span> <input type="text" name="category"
					id="pwd" value="<%= p.getCategory()%>">
			</div>
			<div class="form-field d-flex align-items-center">
				<span class="fas fa-key"></span> <input type="number"
					name="price" id="pwd" value="<%= p.getPrice()%>">
			</div>
			<div class="form-field d-flex align-items-center">
				<span class="far fa-user"></span> <input type="number" name="stock"
					id="userName" value="<%= p.getStock()%>">
			</div>
			
			<button class="btn mt-3 bg-c" style="color:black;" >Edit</button>
		</form>
