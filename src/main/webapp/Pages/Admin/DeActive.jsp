...
<body>
	<div class="fixed-top ">
		...
		<header id="header" class="fixed-top ">
			<div
				...
				<!-- .navbar -->
				<form action="DeActive.jsp" method="get">
		...
		<div class="container-fluid mt-3 bm">
			<div class="row mt-3 justify-content-evenly">
				<div class="col-2">
					<a href="Active.jsp?msg=Active"><button
							class="btn btn-outline-success btn-block p-3" id="m">Active
							Merchants</button></a>
				</div>
				<div class="col-2">
					<a href="DeActive.jsp?msg=deActive"><button
							class="btn btn-outline-primary btn-block p-3" id="m">De-Active
							Merchants</button></a>
				</div>
				<div class="col-2 text-center">
					<a href="All.jsp?msg=All"><button
							class="btn btn-outline-info btn-block p-3" id="m">All
							Merchants</button></a>
				</div>
				<div class="col-2">
					<a href="Blocked.jsp?msg=Blocked"><button
							class="btn btn-outline-danger btn-block p-3" id="m">
							Blocked Merchant</button></a>
				</div>
				<div class="col-2">
					<a href="UnBlocked.jsp?msg=unBlocked"><button
							class="btn btn-outline-warning btn-block p-3" id="m">UnBlocked
							Merchants</button></a>
				</div>
			</div>
		</div>
	...
	<div class="container-fluid">
		...
		<div class="d">
			...
			List<Merchant> merchants = new MerchantDao().getMerchantByStatus(msg);
			...
			List<Merchant> merchant = new MerchantDao().getMerchantByStatus("deActive");
			System.out.println(merchant.isEmpty());
			List<Merchant> lists = new MerchantDao().search(merchant, sr);

			Iterator<Merchant> itr = lists.iterator();
